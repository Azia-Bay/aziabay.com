...
import Button from "./components/blog_button";
  ...
  return (
    <div
      ...
      <Button
        ...
        date={new Date(2026, (9 - 1), 24)}
        title="Devlog: The Creation of aziabay.com"
        tagline="And other ramblings of the mad."
        wordCount={1864}
        src="content/panels/blog/button_spread_aziabay.png"
