...
export default function BlogButton({onClick, date, title, tagline, wordCount, src, alt}: BlogButtonProps) {
  ...
  return (
    <button onClick={onClick} className="group relative overflow-hidden cursor-pointer shrink-0 flex flex-row">
      <div className="relative overflow-hidden min-w-1/2 mr-auto px-4 py-2 rounded-lg rounded-r-none border-4 border-r-0 border-background border-double bg-foreground text-background flex flex-col items-start">
