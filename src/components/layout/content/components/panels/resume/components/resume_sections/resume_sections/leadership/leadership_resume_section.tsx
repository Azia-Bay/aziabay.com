    ...
    <Section
      ...
      <div
        ...
        <Subsection
          ...
          skills={["Java", "Python"]}
          bullets={[
            "Led 9 weekly undergraduate-targeted workshops on data structures and algorithms using Java and Python.",
            "Vetted 50+ candidates for the Association for Computing Machinery Technical Interview Preparation program."]} />
      </div>
    </Section>
  );
}
