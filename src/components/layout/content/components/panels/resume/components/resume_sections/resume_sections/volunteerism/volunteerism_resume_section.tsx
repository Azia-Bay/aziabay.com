    ...
    <Section
      ...
      <div
        ...
        <Subsection
          ...
          hours="60+"
          bullets={[
            "Distributed food and stocked shelves at the Resource Center, a food pantry and health services provider.",
            "Orchestrated entertainment and events for children at the foster care organization Jonathan's Place.",
            "Staffed the ticket booth and hot chocolate booth at the historic farm museum Heritage Farmstead Museum."]} />
      </div>
    </Section>
  );
}
