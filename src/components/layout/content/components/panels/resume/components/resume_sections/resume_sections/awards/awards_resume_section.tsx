  ...
  return (
    <Section
      ...
      <div
        ...
        <Subsection
          title="People's Choice, Research Symposium"
          org="Association for Computing Machinery"
          date="May 2024" />
        
        <Subsection
          title="Founders Fictional Short Story"
          org="Manuel Luis Martinez"
          date="April 2024" />
        
        <Subsection
          title="3rd Place, Game Jam"
          org="Student Game Developer Association"
          date="March 2024" />
        
        <Subsection
          title="Most Innovative, Game Jam"
          org="Student Game Developer Association"
          date="March 2024" />
        ...
        <Subsection
          title="Ninth Circuit Civics Essay Finalist"
          org="U.S. District Court, Northern Mariana Islands"
          date="May 2021" />
        ...
        <Subsection
          title="National Rural Scholar"
          org="CollegeBoard"
          date="February 2021" />
        
        <Subsection
          title="U.S. Presidential Scholar Candidate"
