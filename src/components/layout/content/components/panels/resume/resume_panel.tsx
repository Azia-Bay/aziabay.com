...
export default function ResumePanel() {
  return (
    <div className="scrollbar scroll-smooth overflow-y-auto w-fit rounded-lg mx-auto px-10 py-16 border-4 border-dark border-double flex flex-col gap-4 bg-light text-dark zoom-25 2xs:zoom-30 xs:zoom-40 sm:zoom-50 md:zoom-65 lg:zoom-45 xl:zoom-65 2xl:zoom-80 3xl:zoom-100">
      <Header />
      <EducationSection />
